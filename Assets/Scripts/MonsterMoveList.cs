...
public static class MonsterList
{
   ...
   static MonsterList(){
        ...
        testMon1 = new Monster("TestMonster1", Type.FIRE, Type.NONE, 100, 100, 100, 100, 100, 100, MoveList.fireball, MoveList.recover, MoveList.prod, MoveList.intimidate, Resources.Load<GameObject>("Boximon_Fire/Boximon Fiery"));
        testMon2 = new Monster("TestMonster2", Type.WATER, Type.NONE, 100, 100, 100, 100, 100, 105, MoveList.fireball, MoveList.fireball, MoveList.fireball, MoveList.fireball, Resources.Load<GameObject>("Boximon_Water/Boximon Cyclopes"));
   }
}
...
public static class MoveList
{
    ...
    static MoveList(){
        ...
        fireball = new Move("Fireball", 50, 2, Type.FIRE, Category.PHYSICAL, null);
        droplet = new Move("Droplet", 50, 2, Type.WATER, Category.SPECIAL, null);
        prod = new Move("Prod", 70, 2, Type.NATURE, Category.PHYSICAL, new SecondaryEffect[] {SecondaryEffectList.effectDefDown});
